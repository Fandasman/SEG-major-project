# """Test for reject the application as clubowner view"""
...
#
#
# class RejectApplicationAsOwnerTestCase(TestCase):
#
...
#         self.url = reverse('rejectasowner',kwargs={'club_id':self.club.id,'member_id':self.member_user.id})
#
#
#     def test_remove_member_from_club_url(self):
#         self.assertEqual(self.url,f'/rejectAsOwner/{self.club.id}/{self.member_user.id}')
#

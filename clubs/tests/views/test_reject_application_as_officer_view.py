# """Test for reject the application as officer view"""
...
#
#
# class RejectApplicationAsOfficerTestCase(TestCase):
#
...
#         self.url = reverse('rejectasofficer',kwargs={'club_id':self.club.id,'member_id':self.member_user.id})
#
#
#     def test_remove_member_from_club_url(self):
#         self.assertEqual(self.url,f'/rejectAsOfficer/{self.club.id}/{self.member_user.id}')
#

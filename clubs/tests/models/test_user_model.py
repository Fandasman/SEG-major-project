...
#Genre preferences test cases
    def test_choices_are_selected(self):
        ...
        self.assertEqual(self.user.genres_preferences, ["Crime","Fiction","Horror","Historical","Mystery"])
        self._assert_user_is_valid
    ...
    def test_no_invalid_genres(self):
        ...
        self.user.genres_preferences = ["Crime","Fiction","Horror","Horror","Mystery","aaaaaaaa"]
        self._assert_user_is_invalid

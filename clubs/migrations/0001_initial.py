    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('book_page', models.IntegerField(default=0, validators=[django.core.validators.MaxValueValidator(9999), django.core.validators.MinValueValidator(0)])),
                ('current_book', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='clubs.book')),
            ],
        ),
        migrations.CreateModel(
            name='Role',
